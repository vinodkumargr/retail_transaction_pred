...
class DataIngestionConfig:
    def __int__(self, training_pipeline_config:TrainingPipelineConfig):
        try:
            ...
            self.train_path = os.path.join(self.data_ingestion_dir, "data_split", TRAIN_FILE_NAME)
            self.test_path = os.path.join(self.data_ingestion_dir, "data_split", TEST_FILE_NAME)
            self.test_size = .2
